...
pub use passes::{
    ConstantFoldingError, ExpandMacrosError, ResolveCommError, ResolveContextsError,
    ResolveFreshConfigConstantsError, ResolveFunError, ResolveFunctionWithConfigError,
    ResolveHeatCoolError, ResolveIoError, ResolveStrictError, SubsortKItemError, constant_fold,
    expand_macros, generate_sort_predicate_syntax, generate_sort_projections, guard_or_patterns,
    number_sentences, propagate_macro_attributes, resolve_anon_vars, resolve_comm,
    resolve_config_var, resolve_contexts, resolve_fresh_config_constants, resolve_fun,
